...
enum
{
    ...
    c_waOp_i32_load            = 0x28,
    c_waOp_i64_load            = 0x29,
    c_waOp_f32_load            = 0x2a,
    c_waOp_f64_load            = 0x2b,
    c_waOp_i32_load8_s         = 0x2c,
    c_waOp_i32_load8_u         = 0x2d,
    c_waOp_i32_load16_s        = 0x2e,
    c_waOp_i32_load16_u        = 0x2f,
    c_waOp_i64_load8_s         = 0x30,
    c_waOp_i64_load8_u         = 0x31,
    c_waOp_i64_load16_s        = 0x32,
    c_waOp_i64_load16_u        = 0x33,
    c_waOp_i64_load32_s        = 0x34,
    c_waOp_i64_load32_u        = 0x35,
    c_waOp_i32_store           = 0x36,
    c_waOp_i64_store           = 0x37,
    c_waOp_f32_store           = 0x38,
    c_waOp_f64_store           = 0x39,
    c_waOp_i32_store8          = 0x3a,
    c_waOp_i32_store16         = 0x3b,
    c_waOp_i64_store8          = 0x3c,
    c_waOp_i64_store16         = 0x3d,
    c_waOp_i64_store32         = 0x3e,

    c_waOp_memorySize           = 0x3f,
    c_waOp_memoryGrow           = 0x40,
